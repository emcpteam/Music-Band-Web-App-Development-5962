...
const {FiShoppingBag,FiStar,FiShoppingCart,FiTruck,FiHeart,FiZap,FiPlus,FiLogIn} = FiIcons;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-yellow-50 py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Login Prompt Modal */}
        <motion.div
          className={`fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 ${showLoginPrompt ? '' : 'hidden'}`}
          initial={{ opacity: 0 }}
          animate={{ opacity: showLoginPrompt ? 1 : 0 }}
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Please sign in to purchase items, add to favorites, or proceed to checkout.
            </p>
